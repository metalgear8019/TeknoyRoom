...
var instructor = FlowRouter.group({
	...
	var currentcourses = instructor.group({
		...
		currentcourses.route('/:id', {
			name: 'instructorCurrentEnrollees',
			action: function (params) {
				BlazeLayout.render('instructorLayout', layouts.instructor);
			},
			triggersEnter: [function () {
				layouts.instructor.main = 'instructorClassList';
			}]
		});

		currentcourses.route('/:id/self', {
			name: 'instructorCurrentAttendanceSelf',
			action: function (params) {
				BlazeLayout.render('instructorLayout', layouts.instructor);
			},
			triggersEnter: [function () {
		...
		currentcourses.route('/:id/:userId', {
			name: 'instructorCurrentAttendance',
			action: function (params) {
				BlazeLayout.render('instructorLayout', layouts.instructor);
			},
			triggersEnter: [function () {
				// TODO: update this template that it supports this route params too
				layouts.instructor.main = 'studentAttendance';
			}]
		});
	...
	var previouscourses = instructor.group({
		...
		previouscourses.route('/:id/self', {
			name: 'instructorPreviousAttendanceSelf',
			action: function (params) {
				BlazeLayout.render('instructorLayout', layouts.instructor);
			},
			triggersEnter: [function () {
		...
		previouscourses.route('/:id/:userId', {
